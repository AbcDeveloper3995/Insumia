-- Migración 0009: Rendimiento en Recetas y Subrecetas Recursivas en Ventas
-- Este script permite que una receta produzca N unidades (rendimiento)
-- y que registrar_venta descuente correctamente las subrecetas anidadas.

-- 1. Añadir columna rendimiento
ALTER TABLE recetas 
ADD COLUMN IF NOT EXISTS rendimiento NUMERIC NOT NULL DEFAULT 1;

-- 2. Modificar registrar_venta para resolver subrecetas con CTE recursivo
